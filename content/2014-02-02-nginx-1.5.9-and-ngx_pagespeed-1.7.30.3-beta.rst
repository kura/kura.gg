nginx 1.5.9 and ngx_pagespeed 1.7.30.3-beta
###########################################
...
and published them on `apt.kura.gg <https://apt.kura.gg>`__.

Manual download & install
=========================

+--------------------------------------------------------------------------------+
| `nginx_1.5.9_all.deb </files/nginx_1.5.9_all.deb>`__                           |
+--------------------------------------------------------------------------------+
| `nginx-common_1.5.9_all.deb </files/nginx-common_1.5.9_all.deb>`__             |
+--------------------------------------------------------------------------------+
| `nginx-doc_1.5.9_all.deb </files/nginx-doc_1.5.9_all.deb>`__                   |
+--------------------------------------------------------------------------------+
| `nginx-light_1.5.9_amd64.deb </files/nginx-light_1.5.9_amd64.deb>`__           |
+--------------------------------------------------------------------------------+
| `nginx-full_1.5.9_amd64.deb </files/nginx-full_1.5.9_amd64.deb>`__             |
+--------------------------------------------------------------------------------+
| `nginx-extras_1.5.9_amd64.deb </files/nginx-extras_1.5.9_amd64.deb>`__         |
+--------------------------------------------------------------------------------+
| `nginx-naxsi_1.5.9_amd64.deb </files/nginx-naxsi_1.5.9_amd64.deb>`__           |
+--------------------------------------------------------------------------------+
| `nginx-naxsi-ui_1.5.9_all.deb </files/nginx-naxsi-ui_1.5.9_all.deb>`__         |
+--------------------------------------------------------------------------------+
| `nginx-light-dbg_1.5.9_amd64.deb </files/nginx-light-dbg_1.5.9_amd64.deb>`__   |
+--------------------------------------------------------------------------------+
| `nginx-full-dbg_1.5.9_amd64.deb </files/nginx-full-dbg_1.5.9_amd64.deb>`__     |
+--------------------------------------------------------------------------------+
| `nginx-extras-dbg_1.5.9_amd64.deb </files/nginx-extras-dbg_1.5.9_amd64.deb>`__ |
+--------------------------------------------------------------------------------+
| `nginx-naxsi-dbg_1.5.9_amd64.deb </files/nginx-naxsi-dbg_1.5.9_amd64.deb>`__   |
+--------------------------------------------------------------------------------+
